...
const TriedMain = () => {
    ...
    const totalPageRequest = async () => {
        ...
        try {
            const response = await
                axios.get(`http://localhost:8080/api/tried/totalpage/${triedCategoryIdx}/${order}/${year}-01-01/${year}-12-31/${pages}`, { headers: header });
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await
                axios.get(`http://localhost:8080/api/tried/${triedCategoryIdx}/${order}/${year}-01-01/${year}-12-31/1`, { headers: header });
            let updateData = [];
    ...
    const fetchDataByPage = async () => {
        ...
        try {
            const response = await
                axios.get(`http://localhost:8080/api/tried/${triedCategoryIdx}/${order}/${year}-01-01/${year}-12-31/${pages}`, { headers: header });
            let updateData = [];
            if (pages == 1) {
                updateData = [];
            } else {
